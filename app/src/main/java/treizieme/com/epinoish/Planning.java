...
public class Planning {
    ...
    private ArrayList prof_inst;
    private Integer total_students_registered;
    ...
    public ArrayList getProf_inst() {
        return prof_inst;
    }

    public void setProf_inst(ArrayList prof_inst) {
    ...
    public Integer getTotal_students_registered() {
        return total_students_registered;
    }

    public void setTotal_students_registered(Integer total_students_registered) {
    ...
    public Integer getNum_event() {
        return num_event;
    }

    public void setNum_event(Integer num_event) {
    ...
    public Integer getNb_group() {
        return nb_group;
    }

    public void setNb_group(Integer nb_group) {
